CREATE PROCEDURE [dbo].[rptInvoiceGetForProductSale]
	(
...
BEGIN
    ...
    Delete r from dbo.tblRptInvoiceHdr r join dbo.tblInvoice i on (r.lInvoiceKey = i.lInvoiceKey) Where i.lProductSaleKey = @plProductSaleKey And r.lSessionID = @plSessionID
	Delete r from dbo.tblrptInvoiceProductSaleDetail r join dbo.tblInvoice i on (r.lInvoiceKey = i.lInvoiceKey) Where i.lProductSaleKey = @plProductSaleKey And r.lSessionID = @plSessionID
	...
	Where ih.lSessionID=@plSessionID And ih.sSessionTime=@psSessionTime And i.lProductSaleKey = @plProductSaleKey
END
