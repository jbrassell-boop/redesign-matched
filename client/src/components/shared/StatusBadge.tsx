...
const STATUS_MAP: Record<string, BadgeVariant> = {
  ...
  'closed': 'gray', 'neutral': 'gray', 'draft': 'gray', 'inactive': 'gray', 'not started': 'gray',
  'request fulfilled': 'green', 'request declined': 'red', 'fulfilled': 'green', 'declined': 'red',
  'quoted': 'blue', 'billed': 'purple', 'invoiced': 'purple',
  'pass': 'green', 'fail': 'red', 'conditional': 'amber',
  'waiting on inspection': 'amber', 'waiting for approved': 'amber', 'outsourced': 'blue',
  'in repair process - major repair': 'orange', 'in repair process - minor repair': 'blue',
  'in repair process - mid level repair': 'amber', 'scheduled to ship': 'purple',
  'semi rigid repair': 'blue', 'special rigid - under 4mm': 'blue',
  'additional evaluation time needed': 'amber', 'in the drying room': 'amber',
  'parts hold': 'red', 'qc': 'teal',
  'admin': 'purple',
