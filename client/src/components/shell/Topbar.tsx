      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, color: 'var(--topbar-text)', fontSize: 12 }}>
          ...
          <div ref={menuRef} style={{ position: 'relative', marginRight: 12 }}>
            ...
            >
              <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" style={{ width: 14, height: 14 }}>
...
const MenuItemIcon = ({ type }: { type: string }) => {
  ...
  if (type === 'repair') {
    return (
      <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="var(--navy)" strokeWidth="2" style={style}>
