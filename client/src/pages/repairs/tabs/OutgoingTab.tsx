...
const fLabelStyle: React.CSSProperties = { fontSize: 9, fontWeight: 700, color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: '.03em', marginBottom: 2 };
...
const sectionTitleStyle: React.CSSProperties = { background: 'var(--neutral-50, var(--bg))', padding: '6px 10px', fontSize: 9.5, fontWeight: 700, color: 'var(--navy)', textTransform: 'uppercase', letterSpacing: '.05em', borderBottom: '1px solid var(--border)' };
const sectionBodyStyle: React.CSSProperties = { padding: 10 };
const badgeBaseStyle: React.CSSProperties = { display: 'inline-block', padding: '1px 6px', borderRadius: 10, fontSize: 10, fontWeight: 700 };
...
const trackingReqLabelStyle: React.CSSProperties = { fontSize: 9, fontWeight: 700, color: 'var(--muted)', textTransform: 'uppercase', marginBottom: 4 };
...
const invoiceLabelStyle: React.CSSProperties = { fontSize: 9, opacity: .6, textTransform: 'uppercase', fontWeight: 700 };
...
const invoiceBtnBaseStyle: React.CSSProperties = { padding: '4px 10px', fontSize: 10, fontWeight: 700, color: 'var(--card)', border: '1px solid rgba(255,255,255,.3)', borderRadius: 4, cursor: 'pointer', fontFamily: 'inherit' };
...
const thLeftStyle: React.CSSProperties = { padding: '5px 8px', textAlign: 'left', fontWeight: 600, fontSize: 10 };
const thCenterStyle: React.CSSProperties = { padding: '5px 8px', textAlign: 'center', fontWeight: 600, fontSize: 10 };
const thRightStyle: React.CSSProperties = { padding: '5px 8px', textAlign: 'right', fontWeight: 600, fontSize: 10 };
