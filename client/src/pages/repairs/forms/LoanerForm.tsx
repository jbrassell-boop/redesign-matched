...
export const LoanerForm = ({ repair, onClose }: Props) => {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 1000, background: 'rgba(0,0,0,0.4)', backdropFilter: 'blur(2px)', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', overflow: 'auto', padding: '20px 0' }}>
      <div className="print-form" style={{ width: '8.5in', background: 'var(--card)', fontFamily: "'Inter', Arial, sans-serif", fontSize: '10.5px', color: '#111' }}>
        {/* Print/Close */}
        ...
        <div style={{ padding: '0.45in', display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          <div>
            <div style={{ background: '#FEF9E7', border: '1.5px solid var(--warning)', borderRadius: 3, padding: '5px 10px', fontSize: '9.5px', fontWeight: 700, color: '#92400E', margin: '3px 0' }}>
              Return deadline: 5 business days from delivery. Late fee: $200.00 per day after due date.
            </div>
            <div style={{ fontSize: '9.5px', color: '#333', lineHeight: 1.5, padding: '6px 10px', background: 'var(--bg)', border: '1px solid #eee', borderRadius: 3 }}>
          ...
          <div style={{ marginTop: 6, fontSize: '9.5px', color: '#444', padding: '5px 10px', background: 'var(--bg)', border: '1px solid #eee', borderRadius: 3 }}>
...
const thS: React.CSSProperties = { background: 'var(--primary)', color: '#fff', fontSize: 8, fontWeight: 700, textTransform: 'uppercase', padding: '4px 7px', textAlign: 'left', letterSpacing: '.04em', borderRight: '1px solid rgba(255,255,255,.2)' };
