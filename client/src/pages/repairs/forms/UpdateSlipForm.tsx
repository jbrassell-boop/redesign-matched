      ...
      <div className="print-form" style={{ width: '8.5in', background: '#fff', fontFamily: "'Inter', Arial, sans-serif", fontSize: 11, color: '#111' }}>
        ...
        <div style={{ padding: '0.5in', display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          <div style={{ background: '#FEF2F2', border: '2px solid #FECACA', borderRadius: 4, padding: '8px 16px', textAlign: 'center' }}>
            <div style={{ fontSize: 13, fontWeight: 800, color: '#B71234', textTransform: 'uppercase', letterSpacing: '.12em' }}>Internal Use Only</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px 24px', padding: '8px 0' }}>
            {['Image', 'Lights', 'Buttons', 'Leaks', 'Angulation', 'Video Features'].map(label => (
              <div key={label} style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                <div style={{ fontSize: 9, fontWeight: 700, textTransform: 'uppercase', color: '#2E75B6', letterSpacing: '.05em', padding: '3px 8px', background: '#EFF6FF', borderLeft: '3px solid #2E75B6' }}>{label}</div>
