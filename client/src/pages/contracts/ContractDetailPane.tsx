...
const IconDoc = () => (
  <svg aria-hidden="true" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" style={{ width: 14, height: 14 }}>
        ...
        actions={
          <div style={headerActionsStyle}>
            <button style={actionBtnStyle}>
              <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={actionBtnIconStyle}>
