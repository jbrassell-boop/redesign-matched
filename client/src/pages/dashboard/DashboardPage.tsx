...
export const DashboardPage = () => {
  ...
  const chips: StatChipDef[] = stats ? [
    ...
    ...((stats.expiringContracts ?? 0) > 0 ? [{
      id: 'expiringContracts', label: 'CONTRACTS EXPIRING', value: stats.expiringContracts!, color: 'amber' as const,
      state: 'warn' as const, tooltip: `${stats.expiringContracts} contracts expiring within 90 days`,
    }] : []),
  ] : [];
