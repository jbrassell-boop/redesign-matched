...
const devStatusLabelStyle: React.CSSProperties = { fontSize: 11, fontWeight: 700, color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: '0.05em' };
...
const devStatChipLabelStyle: React.CSSProperties = { fontSize: 11, fontWeight: 600, color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: '0.04em' };
...
const devListHeaderStyle: React.CSSProperties = { background: 'var(--neutral-50)', padding: '5px 10px', fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', color: 'var(--navy)', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 };
const devListHeaderCountStyle: React.CSSProperties = { fontSize: 11, fontWeight: 500, color: 'var(--muted)', textTransform: 'none', letterSpacing: 0 };
...
const devThStyle: React.CSSProperties = { background: 'var(--neutral-50)', color: 'var(--neutral-500)', fontWeight: 600, padding: '8px 12px', textAlign: 'left', whiteSpace: 'nowrap', borderRight: '1px solid rgba(var(--border-light-rgb), 0.3)', borderBottom: '1px solid var(--neutral-200)', letterSpacing: '0.04em', textTransform: 'uppercase', fontSize: 11 };
const devTdIdStyle: React.CSSProperties = { ...tdStyle, width: 42, textAlign: 'right', fontSize: 11, fontWeight: 700, color: 'var(--muted)' };
...
const devDetailTitleStyle: React.CSSProperties = { flex: 1, fontSize: 12, fontWeight: 700, color: 'var(--navy)', lineHeight: 1.3, wordBreak: 'break-word' };
