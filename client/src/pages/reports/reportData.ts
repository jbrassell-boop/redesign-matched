...
export const REPORTS: ReportDef[] = [
  ...
  { id: 'scope-repair-list', cat: 'Repair Reports', name: 'Scope Repair List', desc: 'Repair listing by date, status, technician, sales rep, and instrument type.', lastRun: 1 },
  { id: 'scope-repair-hist', cat: 'Repair Reports', name: 'Scope Repair History', desc: 'Historical repair data by client/dept with detail, amounts, totals, GL/SMT, and consumption toggles.', lastRun: 4 },
  { id: 'repair-metrics', cat: 'Repair Reports', name: 'Repair Metrics', desc: 'Performance metrics by client and date range.', lastRun: 3 },
  { id: 'repair-counts-item', cat: 'Repair Reports', name: 'Repair Counts by Repair Item', desc: 'Repair frequency by item with high-level summary and instrument type filter.', lastRun: null },
  { id: 'billable-report', cat: 'Repair Reports', name: 'Billable Report', desc: 'Billable repairs by client with summary or scope type breakdown.', lastRun: 7 },
  { id: 'parent-child-items', cat: 'Repair Reports', name: 'Parent Child Repair Items', desc: 'Part dependency hierarchy \u2014 parent/child item relationships by instrument type.', lastRun: 12, extractOnly: true },
  ...
  { id: 'revenue-per-state', cat: 'Financial Reports', name: 'Revenue per State', desc: 'Revenue breakdown by state for territory analysis.', lastRun: null },
  { id: 'revenue-per-rep', cat: 'Financial Reports', name: 'Revenue per Sales Rep', desc: 'Revenue totals grouped by sales representative.', lastRun: 4 },
  ...
  { id: 'client-sales-summ', cat: 'Client Reports', name: 'Client Sales Summary', desc: 'Revenue summary by client and department, split by contract vs. non-contract.', lastRun: 5 },
  { id: 'dept-audit', cat: 'Client Reports', name: 'Department Audit', desc: 'Client/department listing with customer-since date and last date in.', lastRun: 10 },
  { id: 'dept-contacts', cat: 'Client Reports', name: 'Department Contacts', desc: 'Department contact list with shipping addresses.', lastRun: null, extractOnly: true },

  // Sales Reports
  { id: 'sales-invoices', cat: 'Sales Reports', name: 'Sales Rep Invoices', desc: 'Invoice listing by sales rep with date range, sortable by invoice date.', lastRun: 3 },
  { id: 'monthly-sales', cat: 'Sales Reports', name: 'Monthly Sales', desc: 'Monthly revenue totals across all reps and accounts.', lastRun: 7 },
  { id: 'sales-by-account', cat: 'Sales Reports', name: 'Sales by Account', desc: 'Revenue breakdown by client account with sales rep filter.', lastRun: null },
  ...
  { id: 'net-new-customers', cat: 'Sales Reports', name: 'Net New Customers', desc: 'New customer acquisitions by sales rep with summary/detail view.', lastRun: 14, extractOnly: true },
  { id: 'sales-leaderboard', cat: 'Sales Reports', name: 'Sales Rep Leaderboard', desc: 'Monthly rankings by summary, net new customers, or work orders.', lastRun: 1, extractOnly: true },
  { id: 'commissions-xref', cat: 'Sales Reports', name: 'Commissions Cross Reference', desc: 'Monthly commission cross-reference by sales rep.', lastRun: null, extractOnly: true },
  ...
  // Quality Reports
  { id: 'non-conformance', cat: 'Quality Reports', name: 'Non-Conformance Report', desc: 'Quality non-conformance events by date range and instrument type.', lastRun: 3 },
  { id: 'po-receipts', cat: 'Quality Reports', name: 'Purchase Order Receipts', desc: 'PO receipt inspection records with lot number tracking.', lastRun: null },
  ...
  { id: 'missing-docs', cat: 'Quality Reports', name: 'Invoiced Repairs with Missing Docs', desc: 'Invoiced repairs flagged for incomplete or missing documentation.', lastRun: 2 },
  { id: 'defect-tracking', cat: 'Quality Reports', name: 'Defect Tracking Report', desc: 'Defect frequency and trending by instrument type and date range.', lastRun: null },
  { id: 'repairs-40-days', cat: 'Quality Reports', name: 'Repairs Within 40 Days', desc: 'Repeat repairs on same scope within 40-day warranty/SLA threshold.', lastRun: 5 },
  ...
  { id: 'vendor-tracking', cat: 'Operations Reports', name: 'Vendor Tracking', desc: 'Subcontractor and vendor repair tracking by client and vendor.', lastRun: null },
  ...
  { id: 'activity-tracking', cat: 'Operations Reports', name: 'Activity Tracking', desc: 'Repair activity by date field with wildcard item filtering.', lastRun: 4, extractOnly: true },
  { id: 'client-report-card', cat: 'Operations Reports', name: 'Client Report Card', desc: 'Consolidated client performance: monthly breakdown, serial counts, and loaner requests.', lastRun: 1, extractOnly: true },
  ...
  { id: 'at-risk-depts', cat: 'Operations Reports', name: 'At Risk Departments', desc: 'Department profitability risk analysis with configurable expense thresholds.', lastRun: null, extractOnly: true },
  { id: 'trending-workflow', cat: 'Operations Reports', name: 'Trending Workflow and Expenses', desc: 'Workflow and expense trending by repair detail, client, and department.', lastRun: null, extractOnly: true },
];
